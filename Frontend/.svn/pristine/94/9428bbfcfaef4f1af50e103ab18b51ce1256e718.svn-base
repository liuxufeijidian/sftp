...
! function(a) {
	a.extend(a.fn, {
		...
		"rules" : function(b, c) {
			...
			if (b) {
				...
				switch(b) {
				case"add":
					a.extend(g, a.validator.normalizeRule(c)), f[d.name] =
					g, c.messages && (e.messages[d.name] = a.extend(e.messages[d.name], c.messages));
					break;
				case"remove":
					if (!c)
						return
		...
		"prototype" : {
			...
			"element" : function(b) {
				b = this.validationTargetFor(this.clean(b)), this.lastElement =
				b, this.prepareElement(b), this.currentElements = a(b);
			...
			"check" : function(b) {
				...
				return e ?
				void 0 : (this.objectLength(d) && this.successList.push(b), !0)
			},
			...
			"formatAndAdd" : function(b, c) {
				...
				"function" == typeof d ? d = d.call(this, c.parameters, b) : e.test(d) && ( d = a.validator.format(d.replace(e, "{$1}"), c.parameters)), this.errorList.push({
					"message" : d,
					"element" : b
				}), this.errorMap[b.name] =
				d, this.submitted[b.name] =
				d
			},
		...
		"attributeRules" : function(b) {
			...
			for (var e in a.validator.methods) {
				var f;
				"required" === e ? ( f = d.get(0).getAttribute(e), "" === f && ( f = !0),
				f = !!f) : f = d.attr(e), f ? c[e] = f : d[0].getAttribute("type") === e && (c[e] = !0)
			}
		...
		"methods" : {
			...
			"remote" : function(b, c, d) {
				...
				if (this.settings.messages[c.name] || (this.settings.messages[c.name] = {}), e.originalMessage = this.settings.messages[c.name].remote, this.settings.messages[c.name].remote = e.message,
					d = "string" == typeof d && {
						"url" : d
					} || d, e.old === b)
					return e.valid;
				...
				return g[c.name] = b, a.ajax(a.extend(!0, {
					...
					"success" : function(d) {
						...
						if (g) {
							...
							f.prepareElement(c), f.formSubmitted =
							h, f.successList.push(c),
	...
	if (a.ajaxPrefilter)
		a.ajaxPrefilter(function(a, c, d) {
			var e = a.port;
			"abort" === a.mode && (b[e] && b[e].abort(), b[e] =
			d)
		});
	else {
		var c = a.ajax;
