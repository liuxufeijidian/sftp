    ...
    $.extend($.jgrid, {
        ...
        search: {
            ...
            afterRedraw: function() {
                $(this).find('.delete-rule').val('X');
                $(this).find('.add-rule').addClass('btn btn-xs btn-primary');
                $(this).find('.add-group').addClass('btn btn-xs btn-success');
                $(this).find('.delete-group').addClass('btn btn-xs btn-danger');
            },
            //c
            caption: "搜索...",
            Find: "查找",
