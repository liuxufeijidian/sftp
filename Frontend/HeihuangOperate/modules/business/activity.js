...
function initTypeGrid() {
	$('#type-jqgrid').jqGrid(
			{
				url : '/business/findActivityParam',
				datatype : 'json',
				mtype : 'POST',
				height : '370',
				colNames : [ 'id', '电话', '车库', '车位', '车牌', '小区', '备注', '房间号',
						'订单状态','活动类型', 'time' ,'节前时间','节后时间'],
				colModel : [ {
					name : 'id',
					index : 'id',
					width : 60,
			 ...
			 * $("#addConstForm").find("input[name=id]").val(id); lastSel = id;
			 * var params = $('#val-jqgrid').jqGrid("getGridParam", "postData");
